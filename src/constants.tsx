...
export const Icons = {
  Laptop: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M20 16V8a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8"/><rect width="20" height="4" x="2" y="16" rx="1"/><path d="M8 20h8"/></svg>
  ),
  Users: (props: any) => (
